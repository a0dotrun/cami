...
async def get_info(patient_id) -> dict:
    ...
    return {
        ...
        "hospitalisation_days": claims_doc.get("discharge_report").get("hospitalization_days", {}).get("value", 0),
        "sum_insured": 500000 if policy_id == "CAMI2025-Lite" else 1000000,  # Todo: Change the hardcoded values
